...
import { getSegmentConditionsTable, } from './pipelineTableLayout';

export default function SegmentDetailGenerator(options) {
  let { getSegmentRulesetRulesTable, } = options;
  return class SegmentDetail extends Component {
    constructor(props) {
      super(props);
      this.state = {
      };
