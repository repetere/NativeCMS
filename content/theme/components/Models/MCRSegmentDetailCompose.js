...
class MCRSegmentDetailCompose extends Component {
  constructor(props){
    super(props);
    let segmentData = {};
  ...
  editSegment(formdata) {
    ...
    request(constants.pipelines.all.BASE_URL + constants.pipelines.segments.POST_NEW,
      ...
      .catch(e => {
        this.props.handleErrorNotification({ message:'Could not create a MCR new Segment. '+e, }, e);
      });
  }
    ...
    return (
      <View style={{ flex:1, alignSelf:'stretch', }}>
        <ScrollView style={styles.scrollViewStandardContainer} contentContainerStyle={[ styles.scrollViewStandardContentContainer, { padding:10, paddingBottom:120, }]} >
          <H2>New MCR Segment: {_segment.title}</H2>
...
export default MCRSegmentDetailCompose;